  ...
  const schema = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        description:
          "Metal Products Company designs and manufactures rugged, pressure-safe oilfield tanks built to handle extreme conditions, transport, and regulatory compliance across the United States.",
        logo: {
          "@type": "ImageObject",
          url: "https://www.metalproductsusa.com/logo.png",
        },
      ...
      },
      {
        ...
        description:
          "High-performance oilfield tanks built in the U.S. for durability, safety, and compliance — engineered to withstand pressure, rough handling, and harsh environments.",
        mainEntityOfPage: {
          "@type": "WebPage",
          "@id": "https://www.metalproductsusa.com/oilfield-tanks-resources",
        },
