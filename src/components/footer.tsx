...
const Footer: React.FC = () => {
  return (
    <footer className='relative bg-[#efefef] font-inter items-end -mt-1 h-96 scrn-1000:h-80 scrn-1600:h-96 scrn-1900:h-120 scrn-2250:h-128 border-t-2 border-green-300 border-dashed'>
