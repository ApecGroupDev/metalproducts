...
export const metadata: Metadata = {
  ...
  description:
    "Find oilfield tanks made for secure storage and environmental safety. Designed to handle demanding oilfield conditions.",
  robots: "index,follow",
  alternates: {
...
const OilfieldTanksResources: React.FC = () => {
  return (
...
export default OilfieldTanksResources;
