...
const Trust_Underground: React.FC = () => {
  return (
    <section className="relative bg-[#f7f4f0] py-28 overflow-hidden">
      <style>{`
        .ugt-display { font-family: var(--font-oswald), sans-serif; }
        .ugt-serif   { font-family: var(--font-libre), serif; }
        .ugt-mono    { font-family: var(--font-space-mono), monospace; }
      ...
      <div className="absolute inset-0 ugt-paper-grid pointer-events-none" />
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-6 md:px-16">
        ...
        >
          <div className="flex items-center gap-3 mb-5">
            ...
            <span className="ugt-mono text-[#c62931] text-xs tracking-[0.45em] uppercase">
              Our Reputation
            </span>
          </div>
          <h2 className="ugt-display font-bold text-[#1a1a1a] uppercase leading-[0.9] text-[clamp(2.4rem,4vw,3.6rem)]">
            Why Your Peers
            <br />
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-4">
              {trustPoints.map((point, i) => (
                ...
                >
                  ...
                  <p className="ugt-mono text-[#555] text-sm leading-7">
                    {point}
                  </p>
                </div>
              ))}
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <div className="w-5 h-px bg-[#c62931]" />
              <span className="ugt-mono text-[#c62931] text-[10px] tracking-[0.45em] uppercase">
                Case Study
              </span>
            </div>
            <h3 className="ugt-display font-bold text-[#1a1a1a] uppercase text-xl mb-4">
              Case in Point
            </h3>
            <p className="ugt-mono text-[#555] text-sm leading-7">
              A rural municipal fueling station recently switched to our
              underground tanks. The installation met all EPA guidelines and was
              completed on schedule— earning the municipality’s regulators
              praise for workmanship.
            </p>
          </motion.div>
        </div>
      </div>
