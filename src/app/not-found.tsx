...
export default function NotFound() {
  return (
    <div className="flex flex-col items-center justify-center bg-[#e3e3e3] min-h-[70vh]">
      <div className="text-center z-40 mt-40 sm:mt-32 lg:mt-20 xl:mt-24">
        <p className="text-gray-800 px-4 flex flex-col">
          <span className="text-gray-800 text-9xl md:text-10xl lg:font-extrabold lg:text-gray-900 lg:text-12xl xl:text-[16rem]">
            404
          </span>{" "}
          <br />
          <span className="text-red-600 font-bold text-3xl sm:text-4xl md:text-5xl lg:text-7xl xl:text-8xl">
            Page Not Found
          </span>{" "}
          <br />
