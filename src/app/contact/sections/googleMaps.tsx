...
const GoogleMaps: React.FC = () => {
  return (
    <div className='items-center w-full mx-auto h-auto max-w-[1440px] px-4 scrn-600:px-6 scrn-1000:px-8 my-20'>
      {/* Google Maps Section */}
      <h2 className='text-center text-4xl font-semibold uppercase text-gray-800 mb-4'>
        Find Us on Google Maps
      </h2>
      <div className='h-[300px] scrn-600:h-[400px] scrn-1000:h-[500px] rounded-xl overflow-hidden shadow-2xl w-full'>
        <iframe
