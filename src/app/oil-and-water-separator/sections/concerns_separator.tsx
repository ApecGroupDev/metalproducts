...
const Concerns_Separator: React.FC = () => {
  return (
    <section className="relative bg-[#111] py-28 overflow-hidden">
      <style>{`
        .sepcon-display { font-family: var(--font-oswald), sans-serif; }
        .sepcon-serif   { font-family: var(--font-libre), serif; }
        .sepcon-mono    { font-family: var(--font-space-mono), monospace; }
