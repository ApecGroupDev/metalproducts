...
const Hero_About: React.FC = () => {
  return (
    <section className="relative overflow-hidden py-40 flex flex-col">
      <style>{`
        .about-h-display { font-family: var(--font-oswald), sans-serif; }
        .about-h-serif   { font-family: var(--font-libre), serif; }
        .about-h-mono    { font-family: var(--font-space-mono), monospace; }
