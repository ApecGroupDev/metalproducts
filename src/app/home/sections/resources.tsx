    ...
    <section className="relative py-28 border-b border-[#e3e3e3]">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          <h2 className="text-gray-900 text-5xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
          {resources.map((item, i) => (
            ...
            >
              {/* Image */}
              <div className="relative w-full h-80 md:h-96 overflow-hidden bg-gray-50">
                <Image
                  src={item.image}
                  alt={item.title}
                  fill
              ...
              <div className="px-8 pt-10 pb-6">
                <p className="text-gray-900 font-semibold text-2xl sm:text-3xl xl:text-4xl whitespace-pre-line leading-snug tracking-wide">
                  {item.title}
                </p>
              </div>
              ...
              <div className="pb-12">
                <Link
                  href={item.link}
                  className="inline-block text-[#c62931] font-semibold text-lg sm:text-xl hover:text-black transition-colors duration-300"
                >
                  Learn more →
                </Link>
              </div>
