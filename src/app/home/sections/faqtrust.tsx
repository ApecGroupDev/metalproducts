...
const FAQTrust: React.FC = () => {
  return (
    <section className="relative bg-[#f8f8f8] py-24 lg:py-32 border-gray-200">
      <div className="max-w-[1440px] mx-auto px-6 md:px-12">
        ...
        <motion.h2
          ...
          className="text-center text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#c62931] tracking-tight mb-16"
        >
        ...
        >
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#c62931] mb-10 text-center lg:text-left">
            Why Customers Trust Us
          </h2>

          <p className="text-gray-700 text-lg sm:text-xl leading-relaxed mb-12 max-w-3xl mx-auto lg:mx-0">
          ...
          <ul className="grid sm:grid-cols-2 gap-6 text-gray-800 text-base sm:text-lg max-w-5xl mx-auto lg:mx-0">
          ...
          <p className="mt-12 text-gray-700 text-lg sm:text-xl italic max-w-3xl mx-auto lg:mx-0 border-l-4 border-[#c62931] pl-6">
